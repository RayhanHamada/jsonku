...
public interface JSONListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JSONParser#root}.
	 * @param ctx the parse tree
	 */
	void enterRoot(JSONParser.RootContext ctx);
	/**
	 * Exit a parse tree produced by {@link JSONParser#root}.
	 * @param ctx the parse tree
	 */
	void exitRoot(JSONParser.RootContext ctx);
	/**
